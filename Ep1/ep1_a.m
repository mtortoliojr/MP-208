...
xlabel('Realizações');
ylabel('Erro RMS');
legend('Erro RMS teórico','Erro RMS do estimador LS','Erro RMS médio do estimador LS');
title(['Estimador LS: Erros RMS para 100 realizações de theta e para k igual a 10.']);
hold off;
saveas(gcf,'fig1_a', 'jpg' );
...
title(['Estimador LS: Valores de theta 1 para 100 realizações e para k igual a 10.']);
hold off;
...
title(['Estimador LS: Valores de theta 2 para 100 realizações e para k igual a 10.']);
hold off

saveas(gcf,'fig2_a', 'jpg' );
